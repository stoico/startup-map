...
let data = {
  ...
  testing: ko.observable("Just a test"),
...
let makeMarkerBounce = function(location) {
...
let listItemClick = function(location) {
  this.makeMarkerBounce(location);
  this.getJobPosting(location);
  this.toggleDescription(location);
};

// This function will loop through the markers array and display them all.
let showListings = function() {
